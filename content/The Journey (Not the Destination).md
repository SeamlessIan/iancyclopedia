...
- It's easy to tell whether or not we're on track to accomplish our goals with some simple math. If
::: (hours remaining in year / total hours in year) 
:is greater than
::: (hours remaining in goal / total hours in goal),
